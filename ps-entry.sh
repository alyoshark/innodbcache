...
# https://github.com/percona/percona-docker/blob/246a3952291a53fecad2e7b764e8b3ec5e0f85bb/percona-server.57/ps-entry.sh
...
exec "$@" --daemon_memcached_option="-p11211"
